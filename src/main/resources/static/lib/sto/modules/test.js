    ...
    var obj = {
        ...
        addOption: function(options){
            ...
            $.each(settings.data, function(key){
                optionGroup += '<option value="'+settings.data[key]+'">'+settings.data[key]+'</option>';
            });
        ...
        addTags: function(options){
            ...
            $this.each(function () {
                ...
                $.each(options.value,function(key){
                    tagsGroup += '<a href="javascript:void(0);" value="'+options.value[key].id+'"><span>'+options.value[key].name+'</span><em></em></a>';
                ...
                if(hasWarp){
                    var str =
                        ...
                        '<input type="hidden" class="tags-input" value="'+tagsVal+'" name="">'+
                        '</div>';
                    that.append(str);
                }else{
